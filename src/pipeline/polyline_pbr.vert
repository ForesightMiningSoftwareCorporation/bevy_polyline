...
void main() {
    ...
    vec3 direction_unnormalized = I_Point1 - I_Point0;
    float direction_norm = length(direction_unnormalized);
    vec3 direction = direction_unnormalized / direction_norm;
